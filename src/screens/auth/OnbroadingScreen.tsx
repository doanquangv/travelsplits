  ...
  return (
    <View style = {[globalStyles.container]}>
      <Swiper style={{}}  loop={false} onIndexChanged={num => setIndex(num)} activeDotColor={appColors.white} index={index} >
        <Image source={require('../../assets/images/Onboarding-1.png')} style={{flex:1, width: AppInfo.sizes.WIDTH, height: AppInfo.sizes.HEIGHT, }}/>

        <Image source={require('../../assets/images/Onboarding-2.png')} style={{flex:1, width: AppInfo.sizes.WIDTH, height: AppInfo.sizes.HEIGHT,}}/>

        <Image source={require('../../assets/images/Onboarding-3.png')} style={{flex:1, width: AppInfo.sizes.WIDTH, height: AppInfo.sizes.HEIGHT, }}/>
      </Swiper>
